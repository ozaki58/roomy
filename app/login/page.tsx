    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center">{isSignUp ? "アカウント作成" : "ログイン"}</CardTitle>
          ...
          <Tabs defaultValue="login" onValueChange={(value) => setIsSignUp(value === "signup")}>
            ...
            <TabsContent value="login">
              <form className="space-y-4">
                ...
                <Button type="submit" formAction={login} className="w-full mt-6">
                  ログイン
                </Button>
              </form>
            </TabsContent>
            ...
            <TabsContent value="signup">
              <form className="space-y-4">
                ...
                <Button type="submit" formAction={signup} className="w-full mt-6">
                  アカウント作成
                </Button>
              </form>
            </TabsContent>
